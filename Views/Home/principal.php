...
<body>
                    ...
                    <ul class="navbar-nav float-right">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="../Images/2.jpg" alt="user" class="rounded-circle" width="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="../Images/2.jpg" alt="user" class="rounded-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
    ...
    <script src="../Functions/popper.min.js"></script>
    <script src="../Functions/bootstrap.min.js"></script>
    <script src="../Functions/app.min.js"></script>
    <script src="../Functions/app.init.js"></script>
    <script src="../Functions/app-style-switcher.js"></script>
    <script src="../Functions/perfect-scrollbar.jquery.min.js"></script>
    <script src="../Functions/sparkline.js"></script>
    <script src="../Functions/waves.js"></script>
    <script src="../Functions/sidebarmenu.js"></script>
    <script src="../Functions/custom.min.js"></script>
</body>
